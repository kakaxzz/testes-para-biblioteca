      ...
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .hero-title-highlight {
          color: #fff2e4; font-style: normal; text-shadow: 0 8px 22px rgba(70, 10, 10, 0.2);
        }
        .hero-text {
          font-family: 'Source Sans 3', sans-serif; font-size: 0.9rem; line-height: 1.35;
          color: rgba(255,255,255,0.82); max-width: 250px;
        }
        .hero-logo-wrap {
          display: flex; justify-content: center; align-items: center;
          animation: fadeInSoft 1s ease-out; background: transparent; padding-right: 6px;
        }
        .hero-logo-card {
          width: min(100%, 330px); aspect-ratio: 1 / 1; border-radius: 0;
          background: transparent; box-shadow: none;
          display: flex; align-items: center; justify-content: center; padding: 0;
        }
        .hero-logo {
          width: 100%; height: 100%; object-fit: contain; opacity: 0.23;
        ...
        .catalog-title {
          font-family: 'Playfair Display', serif; font-size: clamp(2rem, 3vw, 2.5rem);
          font-weight: 700; color: #2d1414;
        }
        .catalog-count { font-family: 'Source Sans 3', sans-serif; font-size: 0.92rem; color: #9c8d8d; font-weight: 700; }

        .filters-panel {
          background: rgba(255, 255, 255, 0.92); border: 1px solid rgba(140, 92, 92, 0.16);
          border-radius: 18px; padding: 14px 18px 14px; margin-bottom: 24px;
        ...
        .filter-chip {
          border: none; cursor: pointer; background: #f4e6df; color: #6a2a2a;
          border-radius: 999px; padding: 8px 12px;
          font-family: 'Source Sans 3', sans-serif; font-weight: 700; font-size: 0.88rem;
          transition: transform 0.18s ease, background 0.18s ease;
        }
        .filter-chip:hover { transform: translateY(-1px); background: #e9d2c8; }
        .filter-clear {
          border: none; cursor: pointer; color: #8b1e1e;
          background: rgba(255, 230, 226, 0.95); padding: 10px 16px; border-radius: 999px;
        ...
        .filters-toggle {
          border: 1px solid rgba(139, 30, 30, 0.18); background: white; color: #6a2a2a;
          border-radius: 999px; padding: 10px 18px;
          font-family: 'Source Sans 3', sans-serif; font-weight: 700; cursor: pointer;
        ...
        .filter-box {
          background: #fffdfa; border: 1px solid rgba(139, 30, 30, 0.12);
        ...
        .book-status {
          ...
          font-size: 0.72rem; font-weight: 800; backdrop-filter: blur(8px);
        }
