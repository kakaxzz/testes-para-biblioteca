...
export const CATEGORIAS = [
  "Literatura brasileira", "Literatura estrangeira", "Poesia", "Romance", "Ficcção científica", "fantasia", "Mistério / Suspense", "Terror", "Aventura", "Infantojuvenil", "Clássicos", "Política", "Economia", "Administração", "Culinária",
